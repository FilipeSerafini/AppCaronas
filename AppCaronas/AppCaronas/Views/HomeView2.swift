...
//    }
//
//    static func == (lhs: Endereco2, rhs: Endereco2) -> Bool {
...
//                        }
//                        if (selecao == true){
//                            //                            PrintaMatch2(conjunto: $conjunto, coordRua: $coordRua, nomeRua: $nomeRua).frame(height: UIScreen.main.bounds.height * 0.5)
//                        } else if (selecao == false && mapState == .locationSelected){
//                            
//                            NavigationLink {
//                                ShowResults(searchedAddress: $nomeRua)
//                            } label: {
//                                ZStack{
//                                    Rectangle()
//                                        .cornerRadius(20)
...
//                            }
//                            
////                            NavigationLink(nomeRua){
////                                Button{
////                                    presentationMode
////                                        .wrappedValue.dismiss()
////                                    ShowResultsView(searchedAddress: $nomeRua)
////                                }label: {
////                                    ZStack{
////                                        Rectangle()
////                                            .cornerRadius(20)
